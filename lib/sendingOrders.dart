...
class SendingOrders extends StatefulWidget with NavigationStates {
  final BaseAuth auth;
  SendingOrders(this.auth);
  @override
  State<StatefulWidget> createState() => new _SendingOrdersState();
}

class _SendingOrdersState extends State<SendingOrders> {
  String uId;
  @override
  void initState() {
    super.initState();
                    ...
                    return new ListView(
                      ...
                      return Card(
                        child: ListTile(
                          ...
                          subtitle: Text(
                              document['Duration'] + " " + document['Bill']),
                        ),
                      );
                    }).toList());
                }
