                      ...
                      children: <Widget>[
                        ...
                        MenuItem(
                          ...
                          onTap: () {
                            ...
                            BlocProvider.of<NavigationBloc>(context)
                                .add(NavigationEvents.SearchPharmacy);
                          },
                        ),
                        Divider(
                          height: 64,
                        ...
                        MenuItem(
                          ...
                          onTap: () {
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context)
                                .add(NavigationEvents.PendingOrders);
                          },
                        ),
                        MenuItem(
                          ...
                          onTap: () {
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context)
                                .add(NavigationEvents.SendingOrders);
                          },
                        ),
                        MenuItem(
                          ...
                          onTap: () {
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context)
                                .add(NavigationEvents.ReceivedOrders);
                          },
                        ),
                        Divider(
                          height: 64,
                      ...
                      children: <Widget>[
                        ...
                        MenuItem(
                          ...
                          onTap: () {
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context)
                                .add(NavigationEvents.PharmacyPendings);
                          },
                        ),
                        MenuItem(
                          icon: Icons.person,
                          ...
                          onTap: () {
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context)
                                .add(NavigationEvents.PharmacySendings);
                          },
                        ),
                        MenuItem(
                          icon: Icons.shopping_basket,
                          ...
                          onTap: () {
                            onIconPressed();
                            BlocProvider.of<NavigationBloc>(context)
                                .add(NavigationEvents.PharmacySent);
                          },
                        ),
                        Divider(
                          height: 64,
